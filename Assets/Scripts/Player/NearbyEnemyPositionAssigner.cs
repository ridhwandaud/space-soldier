...
public class NearbyEnemyPositionAssigner : MonoBehaviour {
    ...
    void AssignTokens()
    {
        print("Assigning tokens. There are currently " + nearbyMeleeEnemies.Count + " candidates.");
    ...
    {
        float a = potentialPosition.x - enemyPosition.x;
        float b = potentialPosition.y - enemyPosition.y;
        return a * a + b * b;
    }
